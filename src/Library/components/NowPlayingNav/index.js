...
import {
  container, topSectionContainer, npImg, npDetailsContainer, npTitle, npArtist, npAlbum, npControllerContainer,
  controlButtons, controlButton, npImgContainer, npImgAlt
} from './NowPlayingNavStyles.css'
